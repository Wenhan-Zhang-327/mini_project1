...
def debyr_integral_vector(x,y,z,alpha,lam,f,ex,ey):
    ...
    return numpy.transpose(debyr_integral_v(x,y,z,alpha,lam,f,ex,ey))

debyr_integral_vector([1,2,3,4],[2,2,2,2],[3,3,3,3],0.5,4,2,1,0)
